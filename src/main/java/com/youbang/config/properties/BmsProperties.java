package com.youbang.config.properties;
...
import static com.youbang.core.util.ToolUtil.getTempPath;
import static com.youbang.core.util.ToolUtil.isEmpty;
 ...
 */
@Component
@ConfigurationProperties(prefix = BmsProperties.PREFIX)
