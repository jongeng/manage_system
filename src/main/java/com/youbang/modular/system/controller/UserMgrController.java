...
import com.youbang.common.constant.Dict;
import com.youbang.common.constant.factory.ConstantFactory;
import com.youbang.common.constant.state.ManagerStatus;
import com.youbang.common.constant.tips.Tip;
...
import com.youbang.common.persistence.dao.UserMapper;
import com.youbang.common.persistence.model.User;
import com.youbang.config.properties.BmsProperties;
import com.youbang.core.db.Db;
import com.youbang.core.log.LogObjectHolder;
import com.youbang.core.shiro.ShiroKit;
import com.youbang.core.shiro.ShiroUser;
import com.youbang.core.util.ToolUtil;
import com.youbang.modular.system.dao.UserMgrDao;
import com.youbang.modular.system.factory.UserFactory;
import com.youbang.modular.system.transfer.UserDto;
import com.youbang.modular.system.warpper.UserWarpper;
...
public class UserMgrController extends BaseController {
    ...
    @Permission
    @ResponseBody
    public Object list(@RequestParam(required = false) String name, @RequestParam(required = false) Integer deptid) {
        // @RequestParam(required = false) String beginTime, @RequestParam(required = false) String endTime,
        List<Map<String, Object>> users = managerDao.selectUsers(name,deptid);
    ...
    public String upload(@RequestPart("file") MultipartFile picture) {
        ...
        try {
            String fileSavePath = bmsProperties.getFileUploadPath();
